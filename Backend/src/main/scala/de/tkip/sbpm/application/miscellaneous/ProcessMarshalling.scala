  ...
  private object parseSubjects {
    ...
    def parseSubject(subject: GraphSubject): SubjectLike = {
      ...
      if (!external)
        ...
        ExternalSubject(id, subject.inputPool, multi, subject.relatedSubjectId, None, subject.relatedInterfaceId, subject.isImplementation, subject.externalType, varMap)
      }
    }

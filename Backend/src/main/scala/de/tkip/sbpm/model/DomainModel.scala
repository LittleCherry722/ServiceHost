...
case class Graph(var id: Option[Int], graph: String, date: java.sql.Timestamp, processId: Int)
case class ProcessInstance(var id: Option[Int], processId: Int, graphId: Int, involvedUsers: String, data: String)
case class Process(var id: Option[Int], name: String, graphId: Int = -1, isProcess: Boolean = true, startSubjects: String = null)

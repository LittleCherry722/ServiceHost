...
object Entities {
  val groups = List(
    Group(None, """Grossunternehmen""", true),
  ...
  val roles = List(
    Role(None, """Grossunternehmen""", true),
  ...
  val users = List(
    ...
    (User(None, """Grossunternehmen Mitarbeiter""", true, 8), ("sbpm", "grossunternehmen@sbpm.com", "a1234".bcrypt)),
  ...
  val processes = List(
    (Process(None, """Grossunternehmen""", false) -> loadJson("grossunternehmen")),

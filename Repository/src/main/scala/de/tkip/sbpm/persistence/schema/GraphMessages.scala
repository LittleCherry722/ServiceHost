 ...
 */
object GraphMessagesSchema extends Schema {
  ...
  class GraphMessages(tag: Tag) extends SchemaTable[GraphMessage](tag, "graph_messages") {
    def id = stringIdCol
  ...
  val graphMessages = TableQuery[GraphMessages]
}
...
var gv_elements = {
	...
	inputEdgeExchangeTarget:  "ge_edge_exchange_target",
	inputEdgeExchangeTargetO:	"ge_edge_exchange_target_outer",
	inputEdgeExchangeOrigin:  "ge_edge_exchange_origin",
	inputEdgeExchangeOriginO: "ge_edge_exchange_origin_outer",
	...
	// chooseAgent predefined state
  inputNodeChooseAgent:        "ge_node_choose_agent_outer",
  inputNodeChooseAgentSubject: "ge_node_choose_agent_subject",
...
var gv_topics	= {
	...
	communication:
	{
		 ...
		 * @param {GCsubject} subject A reference to the selected subject.
		 */
		displaySubject:		"tk_graph/displaySubjectHook",

...
object Messages {
  ...
  case class Variable(vId: String, depth: Int,from:SubjectID, messagesSet: collection.mutable.ListBuffer[SubjectToSubjectMessage], lastVariable: collection.mutable.ListBuffer[Variable])

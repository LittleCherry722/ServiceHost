...
object JsonProtocol extends DefaultJsonProtocol {
  ...
  case class DataSetHeader(instance: Int)
  case class MessageHeader(message: String)
  ...
  implicit val dataSetHeaderFormat = jsonFormat1(DataSetHeader)
  implicit val messageHeaderFormat = jsonFormat1(MessageHeader)
